  ...
  return (
    <>
      <nav className="py-2 z-50 bg-gray-200 capitalize text-gray-500 md:fixed md:top-0 md:end-0 md:start-0">
        <div className="container  flex flex-wrap md:flex-nowrap justify-between gap-44 items-center md:space-x-2">
          <div className="logo">
          ...
          >
            <div className="flex flex-col md:flex-row justify-center items-center md:space-x-2">
              {userData && (
                <ul className="flex flex-col md:flex-row gap-8 justify-center items-center md:space-x-2">
                  <li>
            ...
            <ul className="flex flex-col md:flex-row justify-center gap-12 items-center md:space-x-2">
              {userData && (
                <>
                  <li>
                    <NavLink onClick={() => setOpen(false)} to="cart">
                      <i className="fa-solid fa-xl fa-cart-shopping relative text-mainColor">
                        <span className="absolute -top-[13px] left-1/2 -translate-x-1/2 text-xs text-white">
                  ...
                  <li>
                    <NavLink onClick={() => setOpen(false)} to="wishlist">
                      <i className="fa-solid fa-heart text-red-500 text-2xl relative">
              ...
              <li className="space-x-2 text-black">
                <a target="blank" href="https://www.facebook.com/esraagomaa">
                  <i className="fab fa-facebook-f cursor-pointer"></i>
                </a>
                <a
                  target="blank"
                  href="https://www.linkedin.com/in/esraagomaa/"
                >
                ...
                <a target="blank" href="https://github.com/esraagomaa">
                  <i className="fab fa-github cursor-pointer"></i>
                </a>
                <a
                  target="blank"
                  href="https://www.instagram.com/esraagomaa/"
                >
